        ...
        <div className="order-1 lg:order-2 bg-[#2F2F2F] border-[#1b2c68a0] relative rounded-lg">
          ...
          <code className="font-mono text-xs md:text-sm lg:text-base">
            ...
            <div>
              ...
              <span className="text-gray-400">'</span>
              <span className="text-amber-300">Deepali Jaiswal</span>
              <span className="text-gray-400">',</span>
            </div>
            ...
            <div className="ml-8 lg:ml-16 mr-2">
              ...
              <span className="text-gray-400">: [</span>
              <span className="text-amber-300">'JavaScript', 'HTML', 'CSS'</span>
              <span className="text-gray-400">],</span>
            </div>
            <div className="ml-8 lg:ml-16 mr-2">
              <span className="text-white">frontend</span>
              <span className="text-gray-400">: [</span>
              <span className="text-amber-300">'Angular', 'React', 'Next.js', 'Vue js'</span>
              <span className="text-gray-400">],</span>
            </div>
            <div className="ml-8 lg:ml-16 mr-2">
